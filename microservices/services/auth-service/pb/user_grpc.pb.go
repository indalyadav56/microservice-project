...
type UserServiceClient interface {
	CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*RegisterResponse, error)
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
...
type UserServiceServer interface {
	CreateUser(context.Context, *CreateUserRequest) (*RegisterResponse, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *CreateUserRequest) (*RegisterResponse, error) {
