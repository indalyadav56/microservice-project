...
var U = defineComponent({
  ...
  setup(x, { emit: F }) {
    const e = x, z = F, o = ref(""), C = ref(null), a2 = ref(false), u = ref(false), k = [
      ...
      { color: "#5203D1" },
      { color: "#FFC0CB" }
    ], b2 = computed(() => e.activeColor && !k.some((l) => l.color === e.activeColor) || o.value ? `background-color: ${e.activeColor || o.value};` : "background: linear-gradient(to right, rgb(235, 87, 87), rgb(242, 201, 76), rgb(76, 183, 130), rgb(78, 167, 252), rgb(250, 96, 122));"), y = () => {
...
var b = { class: "flex flex-col gap-4" };
...
var K = defineComponent({
  ...
  setup(g, { emit: F }) {
    ...
    const V2 = () => {
      var t, e, o, C;
      if (!i2.value.trim()) {
        b2("Please enter a name before adding an environment.", "error");
        return;
      }
      if (!((t = l.value) != null && t.id)) {
        b2("Please select a collection before adding an environment.", "error");
        return;
      }
      f("submit", {
        name: i2.value,
...
//# sourceMappingURL=chunk-WDUM3B57.js.map
