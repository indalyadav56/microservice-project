...
var f = s(S, [["__scopeId", "data-v-68d5218e"]]);
                ...
                return [
                  createBaseVNode("span", {
                    class: normalizeClass([
                      ...
                      typeof c.name == "string" && typeof unref(p).name == "string" && ((f2 = unref(p).name) != null && f2.startsWith(c.name)) ? "text-c-1 border-c-1" : "text-c-2 hover:text-c-1 border-transparent"
                    ])
...
var g2 = defineComponent({
  __name: "Collection",
  setup($3) {
    const { activeCollection: i } = z(), m = useRouter(), o = ref(null), { y: a2 } = useScroll(o), f2 = computed(() => a2.value > 104);
    return watch(
      i,
      (t) => {
        var e2;
...
//# sourceMappingURL=Collection.vue-CKEECCB7.js.map
