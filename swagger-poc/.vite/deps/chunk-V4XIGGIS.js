...
var require_util = __commonJS({
  "node_modules/ajv/dist/compile/util.js"(exports) {
    ...
    function unescapeFragment(str) {
      return unescapeJsonPointer3(decodeURIComponent(str));
    }
    exports.unescapeFragment = unescapeFragment;
    function escapeFragment(str) {
      return encodeURIComponent(escapeJsonPointer3(str));
    }
    exports.escapeFragment = escapeFragment;
    function escapeJsonPointer3(str) {
      if (typeof str == "number")
        return `${str}`;
      return str.replace(/~/g, "~0").replace(/\//g, "~1");
    }
    exports.escapeJsonPointer = escapeJsonPointer3;
    function unescapeJsonPointer3(str) {
      return str.replace(/~1/g, "/").replace(/~0/g, "~");
    }
    exports.unescapeJsonPointer = unescapeJsonPointer3;
    ...
    function getErrorPath(dataProp, dataPropType, jsPropertySyntax) {
      ...
      return jsPropertySyntax ? (0, codegen_1.getProperty)(dataProp).toString() : "/" + escapeJsonPointer3(dataProp);
    }
...
// node_modules/@scalar/api-client/dist/libs/string-template.js
function i(c2, o2) {
...
// node_modules/@scalar/oas-utils/dist/entities/environment/environment.js
...
// node_modules/@scalar/api-client/dist/routes.js
var a = ((e) => (e.Request = "request", e.Examples = "examples", e.Cookies = "cookies", e.Collection = "collection", e.Schema = "schema", e.Environment = "environment", e.Servers = "servers", e.Workspace = "workspace", e.Settings = "settings", e))(a || {});
...
var r = [
  {
    name: "request.root",
    path: "",
    component: () => import("./RequestRoot.vue-ZPK2JXVQ.js"),
    redirect: (e) => ({
      name: "request",
    ...
    children: [
      {
        ...
        component: () => import("./Request.vue-C5SQSRWI.js")
      },
      {
      ...
      },
      {
        ...
        component: () => import("./Collection.vue-CKEECCB7.js"),
        redirect: () => ({
        ...
        children: [
          {
            name: "collection.overview",
            path: "overview",
            component: () => import("./CollectionOverview.vue-ETZWO2VO.js")
          },
          {
            name: "collection.servers",
            path: "servers",
            component: () => import("./CollectionServers.vue-NWQYHNNQ.js"),
            children: [
              {
          ...
          },
          {
            ...
            path: "environment",
            component: () => import("./CollectionEnvironment.vue-I5ZA3YNV.js")
          },
          {
            name: "collection.authentication",
            path: "authentication",
            component: () => import("./CollectionAuthentication.vue-3PTPMPZX.js")
          },
          {
            name: "collection.cookies",
            path: "cookies",
            component: () => import("./CollectionCookies.vue-REYIBQOL.js")
          },
          {
            name: "collection.scripts",
            path: "scripts",
            component: () => import("./CollectionScripts.vue-MACWPIGG.js")
          },
          {
            name: "collection.sync",
            path: "sync",
            component: () => import("./CollectionSync.vue-ZEXZ3LQF.js")
          },
          {
            name: "collection.settings",
            path: "settings",
            component: () => import("./CollectionSettings.vue-2D3MHVFU.js")
          }
        ]
      }
    ]
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("./Environment.vue-NKV3546Z.js")
      },
      {
      ...
      },
      {
        ...
        component: () => import("./Cookies.vue-GR7J3SYS.js")
      },
      {
      ...
      },
      {
        ...
        component: () => import("./Settings.vue-WBCJMTFS.js")
      }
    ]
  }
];

// node_modules/@scalar/api-client/dist/store/router-params.js
function n2(t2) {
  return () => {
    const a3 = {
...
// node_modules/@scalar/api-client/dist/store/active-entities.js
var Y = ({
  collections: l,
  requestExamples: O3,
  requests: E,
  ...
  const s3 = computed(n2(N)), r4 = computed(
    () => I[s3.value[a.Workspace]] ?? Object.values(I)[0]
  ), d2 = computed(
    () => {
      var e;
    ...
    var n4;
    const e = s3.value[a.Request], t2 = l[s3.value.collection] || l[((n4 = r4.value) == null ? void 0 : n4.collections[0]) ?? ""];
    return E[e] || E[(t2 == null ? void 0 : t2.requests[0]) ?? ""] || Object.values(E)[0];
  }), q2 = computed(() => {
    var t2;
    const e = s3.value[a.Examples] === "default" ? ((t2 = f2.value) == null ? void 0 : t2.examples[0]) || "" : s3.value[a.Examples];
    return O3[e];
  }), S = computed(() => {
    var v2, o2, u;
    const e = l[s3.value[a.Collection]];
    if (e)
      return e;
    ...
    () => {
      var e;
      return s3.value[a.Cookies] === "default" ? ((e = r4.value) == null ? void 0 : e.cookies[0]) ?? "default" : s3.value[a.Cookies];
    }
  ), W2 = computed(() => {
    var u;
...
// node_modules/@scalar/api-client/dist/libs/errors.js
var r2 = {
...
var t = (e, o2 = r2.DEFAULT) => (console.error(e), e instanceof Error ? (e.message = n3(e.message), e) : typeof e == "string" ? new Error(n3(e)) : new Error(o2));
var n3 = (e) => e === "Failed to execute 'append' on 'FormData': parameter 2 is not of type 'Blob'." ? r2.MISSING_FILE : e === "Failed to construct 'URL': Invalid URL" ? r2.INVALID_URL : e === "Failed to execute 'fetch' on 'Window': Invalid name" ? r2.INVALID_HEADER : e;

// node_modules/@scalar/oas-utils/dist/entities/shared/utility.js
var selectedSecuritySchemeUidSchema = z.union([
  z.string().brand(),
  z.string().brand().array()
]).array().default([]);

// node_modules/@scalar/oas-utils/dist/entities/spec/x-scalar-environments.js
...
// node_modules/@scalar/oas-utils/dist/entities/spec/x-scalar-secrets.js
...
// node_modules/@scalar/types/dist/entities/security-scheme.js
...
var credentialsLocationExtension = z.enum(["header", "body"]).optional();
...
// node_modules/@scalar/helpers/dist/object/omit-undefined-values.js
...
// node_modules/@scalar/oas-utils/dist/entities/spec/spec-objects.js
...
// node_modules/@scalar/oas-utils/dist/entities/spec/collection.js
...
// node_modules/@scalar/oas-utils/dist/entities/spec/parameters.js
...
// node_modules/@scalar/types/dist/api-client/api-client-plugin.js
...
// node_modules/@scalar/types/dist/api-reference/api-reference-plugin.js
...
// node_modules/@scalar/oas-utils/dist/spec-getters/get-server-variable-examples.js
var getServerVariableExamples = (server) => {
  const examples = {};
  if (server.variables) {
    for (const [key, variable] of Object.entries(server.variables)) {
      examples[key] = variable.enum?.filter((v2) => typeof v2 === "string") ?? [
        variable.default
      ];
    }
  }
...
// node_modules/@scalar/object-utils/dist/arrays/types.js
function keysOf(obj) {
  return obj ? Object.keys(obj).map((k3) => String(k3)) : [];
}

// node_modules/@scalar/workspace-store/dist/helpers/get-resolved-ref.js
var defaultTransform = (node) => {
  return node["$ref-value"];
};
var getResolvedRef = (node, transform = defaultTransform) => {
...
// node_modules/@scalar/oas-utils/dist/spec-getters/get-example-from-schema.js
var MAX_LEVELS_DEEP = 5;
var MAX_PROPERTIES = 10;
var DEFAULT_ADDITIONAL_PROPERTIES_NAME = "propertyName*";
...
var getExampleFromSchema = (_schema, options, level = 0, parentSchema, name) => {
  ...
  if (schema.type === "array" || schema.items !== void 0) {
    ...
    const isObject3 = items?.type === "object" || items?.properties !== void 0;
    const isArray = items?.type === "array" || items?.items !== void 0;
    if (items?.type || isObject3 || isArray) {
...
// node_modules/@scalar/oas-utils/dist/spec-getters/get-parameters-from-operation.js
...
// node_modules/@scalar/oas-utils/dist/spec-getters/get-request-body-from-operation.js
...
// node_modules/@scalar/oas-utils/dist/entities/spec/request-examples.js
...
function createExampleFromRequest(request, name, server) {
  ...
  request.parameters?.forEach((p2) => parameters[p2.in].push(createParamInstance(p2)));
...
// node_modules/@scalar/oas-utils/dist/entities/spec/requests.js
...
// node_modules/@scalar/object-utils/dist/mutator-record/debounce.js
...
function mutationFactory(entityMap, mutationMap, localStorageKey, maxNumberRecords = MAX_MUTATION_RECORDS) {
  ...
  const onChange = localStorageKey ? debounce(() => safeLocalStorage().setItem(localStorageKey, stringify2(entityMap)), LS_CONFIG.DEBOUNCE_MS, {
...
// node_modules/@scalar/api-client/dist/store/collections.js
function T(s3) {
...
// node_modules/@scalar/api-client/dist/store/cookies.js
function s2(r4) {
...
// node_modules/@scalar/api-client/dist/store/environment.js
function f(n4) {
...
// node_modules/@scalar/api-client/dist/libs/event-bus.js
function a2() {
...
// node_modules/@scalar/api-client/dist/store/events.js
function r3() {
  return {
    /**
...
// node_modules/@scalar/openapi-parser/dist/utils/is-object.js
...
// node_modules/@scalar/openapi-parser/dist/utils/get-entrypoint.js
...
// node_modules/@scalar/openapi-parser/dist/utils/get-list-of-references.js
...
// node_modules/@scalar/openapi-parser/dist/utils/is-filesystem.js
...
// node_modules/@scalar/openapi-parser/dist/utils/make-filesystem.js
...
// node_modules/@scalar/openapi-parser/dist/utils/unescape-json-pointer.js
function unescapeJsonPointer(uri) {
  return decodeURI(uri.replace(/~1/g, "/").replace(/~0/g, "~"));
}

// node_modules/@scalar/openapi-parser/dist/utils/get-segments-from-path.js
...
// node_modules/@scalar/openapi-parser/dist/utils/resolve-references.js
...
// node_modules/@scalar/openapi-parser/dist/utils/escape-json-pointer.js
...
// node_modules/@scalar/openapi-parser/dist/utils/to-json.js
var toJson = (value) => JSON.stringify(value, null, 2);

// node_modules/@scalar/openapi-parser/dist/utils/to-yaml.js
var toYaml = (value) => stringify(value);

// node_modules/@scalar/openapi-parser/dist/utils/upgrade-from-three-to-three-one.js
...
var applyChangesToDocument = (schema, path) => {
  ...
  if (schema.type === "string") {
    ...
    if (schema.format === "byte") {
      const parentPath = path.slice(0, -1);
      const contentMediaType = parentPath.find((_22, index) => path[index - 1] === "content");
      return {
        ...rest,
        type: "string",
        contentEncoding: "base64",
...
// node_modules/@scalar/openapi-parser/dist/utils/upgrade-from-two-to-three.js
...
// node_modules/@scalar/json-magic/dist/utils/escape-json-pointer.js
function escapeJsonPointer2(str) {
  return str.replace(/~/g, "~0").replace(/\//g, "~1");
}

// node_modules/@scalar/json-magic/dist/polyfills/path.js
...
// node_modules/@scalar/json-magic/dist/utils/unescape-json-pointer.js
function unescapeJsonPointer2(uri) {
  return decodeURI(uri.replace(/~1/g, "/").replace(/~0/g, "~"));
}

// node_modules/@scalar/json-magic/dist/utils/get-segments-from-path.js
function getSegmentsFromPath2(path) {
  return (
    // /paths/~1test
    path.split("/").slice(1).map(unescapeJsonPointer2)
  );
}

// node_modules/@scalar/json-magic/dist/utils/is-object.js
var isObject2 = (obj) => typeof obj === "object" && !Array.isArray(obj) && obj !== null;

// node_modules/@scalar/json-magic/dist/utils/is-yaml.js
function isYaml(value) {
  return /^\s*(?:-\s*)?[\w\-]+\s*:\s*.+\n.*/.test(value);
}

// node_modules/@scalar/json-magic/dist/utils/is-json-object.js
...
function setValueAtPath(obj, path2, value) {
  ...
  const parts = getSegmentsFromPath2(path2);
  let current = obj;
...
function prefixInternalRef(input, prefix) {
  ...
  return `#/${prefix.map(escapeJsonPointer2).join("/")}${input.substring(1)}`;
}
...
var resolveAndCopyReferences = (targetDocument, sourceDocument, referencePath, externalRefsKey, documentKey, processedNodes = /* @__PURE__ */ new Set()) => {
  const referencedValue = getNestedValue2(sourceDocument, getSegmentsFromPath2(referencePath));
  ...
  const traverse2 = (node) => {
    ...
    if ("$ref" in node && typeof node["$ref"] === "string") {
      if (node["$ref"].startsWith(`#/${externalRefsKey}/${escapeJsonPointer2(documentKey)}`)) {
...
async function bundle(input, config) {
  ...
  const bundler = async (root, origin = defaultOrigin(), isChunkParent = false, depth = 0, path2 = [], parent = null) => {
    ...
    if (!isObject2(root) && !Array.isArray(root)) {
      return;
    }
    ...
    if (typeof root === "object" && "$ref" in root && typeof root["$ref"] === "string") {
      ...
      if (isLocalRef(ref2)) {
        if (isPartialBundling) {
          const segments = getSegmentsFromPath2(ref2.substring(1));
          const parent2 = segments.length > 0 ? getNestedValue2(documentRoot, segments.slice(0, -1)) : void 0;
          await bundler(getNestedValue2(documentRoot, segments), origin, isChunkParent, depth + 1, segments, parent2);
        }
        return;
      }
      const [prefix, path3 = ""] = ref2.split("#", 2);
      ...
      if (!seen) {
        cache2.set(resolvedPath, resolveContents(resolvedPath, loaderPlugins));
      }
      ...
      if (result.ok) {
        if (!seen) {
          ...
          setValueAtPath(
            documentRoot,
            `/${extensions.externalDocumentsMappings}/${escapeJsonPointer2(compressedPath)}`,
            resolvedPath
          );
        }
...
async function importSpecToWorkspace(content, {
  ...
  keysOf(schema.paths ?? {}).forEach((pathString) => {
    ...
    methods.forEach((method) => {
      ...
      operation.tags?.forEach((t2) => tagNames.add(t2));
  ...
  tags.forEach((t2) => {
    t2["x-scalar-children"]?.forEach((c2) => {
  ...
  requests.forEach((r4) => {
    if (r4.tags?.length) {
      r4.tags.forEach((t2) => {
        tagMap[t2]?.children.push(r4.uid);
      });
    } else {
...
// node_modules/@scalar/api-client/dist/store/import-spec.js
var F = {};
function O({
  requestMutators: s3,
  collectionMutators: l,
...
// node_modules/@scalar/api-client/dist/store/request-example.js
function T2(o2) {
...
// node_modules/@scalar/api-client/dist/store/requests.js
function Q(p2) {
...
// node_modules/@scalar/api-client/dist/store/security-schemes.js
function v(S) {
...
// node_modules/@scalar/api-client/dist/store/servers.js
function R(s3) {
...
// node_modules/@scalar/api-client/dist/store/tags.js
function L(d2) {
...
// node_modules/@scalar/themes/dist/fonts/fonts.css2.js
...
// node_modules/@scalar/themes/dist/presets/alternate.css.js
...
// node_modules/@scalar/themes/dist/presets/bluePlanet.css.js
...
// node_modules/@scalar/themes/dist/presets/deepSpace.css.js
...
// node_modules/@scalar/themes/dist/presets/default.css.js
...
// node_modules/@scalar/themes/dist/presets/elysiajs.css.js
...
// node_modules/@scalar/themes/dist/presets/fastify.css.js
...
// node_modules/@scalar/themes/dist/presets/kepler.css.js
...
// node_modules/@scalar/themes/dist/presets/mars.css.js
...
// node_modules/@scalar/themes/dist/presets/moon.css.js
...
// node_modules/@scalar/themes/dist/presets/laserwave.css.js
...
// node_modules/@scalar/themes/dist/presets/purple.css.js
...
// node_modules/@scalar/themes/dist/presets/saturn.css.js
...
// node_modules/@scalar/themes/dist/presets/solarized.css.js
...
// node_modules/@scalar/themes/dist/utilities/has-obtrusive-scrollbars.js
...
// node_modules/@scalar/oas-utils/dist/entities/hotkeys/hotkeys.js
...
// node_modules/@scalar/api-client/dist/store/store.js
var ge = ({
  ...
  }, { addTag: k3, deleteTag: T3 } = q(t2), { addRequest: I, deleteRequest: O3, findRequestParents: g2 } = g(t2, k3), { deleteEnvironment: j } = d(t2), { addServer: P2, deleteServer: B } = h(t2), { addCollection: H, deleteCollection: K } = Y2(t2), { addRequestExample: Y3, deleteRequestExample: _2 } = _(t2), { addWorkspace: z3, deleteWorkspace: G } = F2(t2), { addSecurityScheme: J, deleteSecurityScheme: N } = k2(t2), { addCollectionEnvironment: h2, removeCollectionEnvironment: F3 } = Y2(t2), Q2 = reactive([]), { importSpecFile: U, importSpecFromUrl: V } = O(t2), W2 = ref((e ? localStorage == null ? void 0 : localStorage.getItem("sidebarWidth") : void 0) || "280px"), X = (s3) => {
...
export {
  getSegmentsFromPath2 as getSegmentsFromPath,
...
//# sourceMappingURL=chunk-V4XIGGIS.js.map
