...
// node_modules/@scalar/api-client/dist/components/IconSelector.vue.js
...
var $ = defineComponent({
  ...
  setup(i, { emit: f }) {
    const b = i, x = f, c = computed({
      get: () => b.modelValue,
      set: (l) => x("update:modelValue", l)
    });
    return (l, r) => (openBlock(), createBlock(unref(z), {
...
//# sourceMappingURL=chunk-E54453MF.js.map
