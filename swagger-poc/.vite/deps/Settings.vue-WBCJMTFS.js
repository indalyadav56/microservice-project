...
// node_modules/@scalar/api-client/dist/components/ImportCollection/IntegrationLogo.vue.js
...
// node_modules/@scalar/api-client/dist/views/Settings/components/SettingsAppearance.vue.js
...
var j = defineComponent({
  ...
  setup(h) {
    ...
    return (w, t) => (openBlock(), createElementBlock("div", C, [
      createVNode(unref($), {
...
// node_modules/@scalar/api-client/dist/views/Settings/components/SettingsSection.vue.js
...
// node_modules/@scalar/api-client/dist/views/Settings/SettingsGeneral.vue.js
...
var _ = "https://proxy.scalar.com";
var ce = defineComponent({
  __name: "SettingsGeneral",
  setup(ee) {
    const { activeWorkspace: o } = z(), { proxyUrl: k2, workspaceMutators: j2 } = je(), L = [
      "default",
      "alternate",
      // 'moon',
      "purple",
      ...
      var t;
      return j2.edit((t = o.value) == null ? void 0 : t.uid, "themeId", x2);
    }, g = cva({
      base: "w-full shadow-none text-c-1 justify-start pl-2 gap-2 border",
      variants: {
        active: {
      ...
      var t;
      return j2.edit((t = o.value) == null ? void 0 : t.uid, "proxyUrl", x2);
    };
                ...
                createBaseVNode("div", H, [
                  createVNode(unref($), {
                    class: normalizeClass(
                      unref(cx)(
                        unref(g)({
                          active: ((s = unref(o)) == null ? void 0 : s.proxyUrl) === _
                        })
                      )
                    ),
                    ...
                    default: withCtx(() => {
                      ...
                      return [
                        createBaseVNode("div", {
                          class: normalizeClass(["flex h-5 w-5 items-center justify-center rounded-full border-[1.5px] p-1", {
                            "bg-c-accent text-b-1 border-transparent": ((l = unref(o)) == null ? void 0 : l.proxyUrl) === _
                          }])
                        }, [
                          ((p = unref(o)) == null ? void 0 : p.proxyUrl) === _ ? (openBlock(), createBlock(unref(m), {
                            key: 0,
                            icon: "Checkmark",
                            size: "xs",
                            thickness: "3.5"
                  ...
                  unref(k2) && unref(k2) !== _ ? (openBlock(), createBlock(unref($), {
                    key: 0,
                    class: normalizeClass(
                      unref(cx)(
                        unref(g)({
                          ...
                          createBaseVNode("div", J, [
                            createBaseVNode("span", {
                              ...
                              style: normalizeStyle({
                                backgroundColor: C2(s).light
                              })
                            }, null, 4),
                            createBaseVNode("span", {
                              class: "border-c-3 -mr-3 inline-block h-5 w-5 rounded-full",
                              style: normalizeStyle({
                                backgroundColor: C2(s).dark
                              })
                            }, null, 4),
                            createBaseVNode("span", {
                              class: "border-c-3 inline-block h-5 w-5 rounded-full",
                              style: normalizeStyle({
                                backgroundColor: C2(s).accent
                              })
                            }, null, 4)
                          ])
                        ];
...
// node_modules/@scalar/api-client/dist/views/Settings/Settings.vue2.js
...
//# sourceMappingURL=Settings.vue-WBCJMTFS.js.map
