...
var te = defineComponent({
  ...
  setup(q2) {
    const { activeCollection: l } = z(), { servers: v, events: x, serverMutators: h } = je(), d = W(), a = ref(null), _ = computed(() => {
      var t;
    ...
    return (t, s) => {
      ...
      return openBlock(), createElementBlock("div", T, [
        createBaseVNode("div", F, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(_.value, (r, k) => (openBlock(), createElementBlock("div", {
            key: r.uid
          }, [
            createBaseVNode("div", O2, [
              createBaseVNode("div", R, [
                r.description ? (openBlock(), createBlock(unref(C), {
                  key: 0,
                  value: r.description,
                  class: "self-center"
...
//# sourceMappingURL=CollectionServers.vue-NWQYHNNQ.js.map
