...
var require_quote = __commonJS({
  "node_modules/shell-quote/quote.js"(exports, module) {
    ...
    module.exports = function quote(xs) {
      return xs.map(function(s8) {
        if (s8 === "") {
          return "''";
        }
        if (s8 && typeof s8 === "object") {
          return s8.op.replace(/(.)/g, "\\$1");
        }
        if (/["\s\\]/.test(s8) && !/'/.test(s8)) {
          return "'" + s8.replace(/(['])/g, "\\$1") + "'";
        }
        if (/["'\s]/.test(s8)) {
          return '"' + s8.replace(/(["\\$`!])/g, "\\$1") + '"';
        }
        return String(s8).replace(/([A-Za-z]:)?([#!"$&'()*,:;<=>?@[\\\]^`{|}])/g, "$1\\$2");
      }).join(" ");
    };
  }
});
...
var require_parse = __commonJS({
  "node_modules/shell-quote/parse.js"(exports, module) {
    ...
    function matchAll(s8, r3) {
      var origIndex = r3.lastIndex;
      var matches = [];
      var matchObj;
      while (matchObj = r3.exec(s8)) {
    ...
    function parseInternal(string, env, opts) {
      ...
      return matches.map(function(match) {
        ...
        function parseEnvVar() {
          ...
          var varend;
          var varname;
          var char = s8.charAt(i6);
          if (char === "{") {
            i6 += 1;
            if (s8.charAt(i6) === "}") {
              throw new Error("Bad substitution: " + s8.slice(i6 - 2, i6 + 1));
            }
            varend = s8.indexOf("}", i6);
            if (varend < 0) {
              throw new Error("Bad substitution: " + s8.slice(i6));
            }
            varname = s8.slice(i6, varend);
            i6 = varend;
          } else if (/[*@#?$!_-]/.test(char)) {
            varname = char;
            i6 += 1;
          } else {
            var slicedFromI = s8.slice(i6);
    ...
    module.exports = function parse(s8, env, opts) {
      var mapped = parseInternal(s8, env, opts);
      if (typeof env !== "function") {
        return mapped;
      }
      return mapped.reduce(function(acc, s9) {
        if (typeof s9 === "object") {
          return acc.concat(s9);
        }
        var xs = s9.split(RegExp("(" + TOKEN + ".*?" + TOKEN + ")", "g"));
        if (xs.length === 1) {
...
function b3(i5) {
  const e3 = (0, import_shell_quote.parse)(i5).map((o) => typeof o == "object" && "op" in o && o.op === "glob" ? o.pattern.trim() : typeof o == "string" ? o.trim() : o).filter((o) => o !== ""), a3 = { url: "" }, t2 = e3[Symbol.iterator]();
  let r3 = t2.next().value;
  for (; r3; )
    r3 === "-X" || r3 === "--request" ? h(t2, a3) : r3 === "--url" ? s3(t2, a3) : r3 === "-H" || r3 === "--header" ? p(t2, a3) : r3 === "--data" || r3 === "-d" || r3 === "--data-raw" || r3 === "--data-urlencode" || r3 === "--data-binary" || r3 === "--data-ascii" ? u2(t2, a3, i5) : typeof r3 == "string" && !a3.url && (r3.startsWith("http") || r3.startsWith("www.")) ? s3([r3][Symbol.iterator](), a3) : r3 === "-P" ? d3(t2, a3) : typeof r3 == "string" && r3.toLowerCase().includes("content-type") ? f5(r3, a3) : r3 === "-u" || r3 === "--user" ? m3(t2, a3) : (r3 === "-b" || r3 === "--cookie") && l(t2, a3), r3 = t2.next().value;
  return a3;
}
function h(i5, e3) {
  e3.method = i5.next().value.toLowerCase();
}
function s3(i5, e3) {
  const a3 = new URL(i5.next().value.replace(/['"]/g, ""));
  e3.servers = [a3.origin], e3.path = a3.pathname !== "/" ? a3.pathname : "", e3.url = e3.servers[0] + e3.path;
  const t2 = n(a3.search);
  e3.queryParameters = e3.queryParameters ? [...e3.queryParameters, ...t2] : t2;
}
function p(i5, e3) {
  const a3 = i5.next().value.split(/:(.*)/);
  e3.headers = e3.headers || {}, a3[1] !== void 0 ? e3.headers[a3[0].trim()] = a3[1].trim() : e3.headers[a3[0].trim()] = "";
}
function d3(i5, e3) {
  const a3 = i5.next().value.replace(/['"]/g, "").split("=");
  e3.pathVariables = e3.pathVariables || {}, a3[1] !== void 0 ? e3.pathVariables[a3[0].trim()] = a3[1].trim() : e3.pathVariables[a3[0].trim()] = "";
}
function n(i5) {
  const e3 = [];
  return new URL(i5, "http://example.com").searchParams.forEach((t2, r3) => {
    e3.push({ key: r3, value: t2 });
  }), e3;
}
function f5(i5, e3) {
  const a3 = i5.replace(/['"]/g, "").split(/:(.+)/);
  e3.headers = e3.headers || {}, a3[0] && (a3[1] !== void 0 ? e3.headers[a3[0].trim()] = a3[1].trim() : e3.headers[a3[0].trim()] = "");
}
function m3(i5, e3) {
  const a3 = i5.next().value;
  try {
    const t2 = btoa(a3);
    e3.headers = e3.headers || {}, e3.headers.Authorization = `Basic ${t2}`;
  } catch (t2) {
    console.warn("Could not base64 encode these HTTP basic auth credentials:", a3, t2);
  }
}
function l(i5, e3) {
  const a3 = i5.next().value;
  e3.headers = e3.headers || {}, e3.headers.Cookie ? e3.headers.Cookie += `; ${a3}` : e3.headers.Cookie = a3.replace(/;$/, "");
}
function u2(i5, e3, a3) {
  const t2 = i5.next().value;
  if (typeof t2 == "string" && (t2.startsWith("@") ? e3.body = "" : e3.body = t2, !e3.url || a3.includes("-G"))) {
    const r3 = n(`?${e3.body}`);
    e3.queryParameters = e3.queryParameters ? [...e3.queryParameters, ...r3] : r3;
  }
}
...
function l2(o) {
  try {
    ...
    const s8 = {};
    return o.split("&").forEach((a3) => {
      const [r3, e3] = a3.split("=");
      r3 && e3 && (s8[decodeURIComponent(r3)] = decodeURIComponent(e3));
    }), s8;
  }
}
function C(o) {
  const s8 = b3(o), { method: a3 = "get", url: r3, body: e3 = "", headers: p6 = {}, servers: i5, queryParameters: m5 = [] } = s8, y = new URL(r3).pathname, d6 = e3 != null && e3.includes("=") && !e3.startsWith("{") ? "application/x-www-form-urlencoded" : p6["Content-Type"] || "", c4 = e3 ? l2(e3) : {}, u3 = [
    ...Array.isArray(m5) ? m5.map(({ key: n2, value: t2 }) => ({
      name: n2,
      in: "query",
      schema: { type: typeof t2, examples: [t2] }
    })) : [],
    ...Object.entries(p6 || {}).map(([n2, t2]) => ({
      name: n2,
      in: "header",
          ...
          [d6]: {
            schema: {
              ...
              properties: Object.fromEntries(
                Object.entries(c4).map(([n2, t2]) => [n2, { type: typeof t2 }])
              )
            },
            example: c4
          }
...
var O = defineComponent({
  ...
  setup(x7) {
    const { hideClientButton: u3, showSidebar: d6, integration: c4 } = je(), { isSidebarOpen: f7 } = m2(), { layout: n2 } = s2(), { currentRoute: b5 } = useRouter();
    return (e3, t2) => (openBlock(), createElementBlock("div", B2, [
      createBaseVNode("div", S, [
        unref(d6) ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass(["size-8", { hidden: unref(n2) === "modal" && !unref(f7) }])
      ...
      createVNode(d2, {
        ...
        onImportCurl: t2[0] || (t2[0] = (a3) => e3.$emit("importCurl", a3))
      }, null, 8, ["collection", "envVariables", "environment", "operation", "server", "workspace"]),
      createBaseVNode("div", $2, [
        unref(n2) === "modal" && e3.collection.documentUrl && !unref(u3) ? (openBlock(), createBlock(unref(f2), {
          key: 0,
          buttonSource: "modal",
          class: "!w-fit lg:-mr-1",
          integration: unref(c4) ?? e3.collection.integration ?? null,
          source: unref(b5).query.source === "gitbook" ? "gitbook" : "api-reference",
          url: e3.collection.documentUrl
        ...
        unref(n2) === "modal" ? (openBlock(), createElementBlock("button", {
          ...
          type: "button",
          onClick: t2[1] || (t2[1] = (a3) => e3.$emit("hideModal"))
        }, [
          createVNode(unref(m), {
            icon: "Close",
            size: "lg",
        ...
        unref(n2) === "modal" ? (openBlock(), createElementBlock("button", {
          ...
          type: "button",
          onClick: t2[2] || (t2[2] = (a3) => e3.$emit("hideModal"))
        }, [
          createVNode(unref(m), {
            icon: "Close",
            size: "md",
...
var x4 = defineComponent({
  ...
  setup(_2) {
    return (e3, f7) => (openBlock(), createBlock(f4, { class: "relative flex" }, {
      default: withCtx(() => [
        createBaseVNode("span", i3, [
          renderSlot(e3.$slots, "default", {}, () => [
            createTextVNode(toDisplayString(e3.text), 1)
          ])
        ])
      ]),
      _: 3
...
var p3 = defineComponent({
  ...
  setup(s8) {
    return (e3, f7) => (openBlock(), createElementBlock("a", {
...
// node_modules/@scalar/api-client/dist/views/Request/ResponseSection/RequestHeaders.vue.js
var H = {
  key: 0,
...
var D = defineComponent({
  ...
  setup(v2) {
    const m5 = (s8) => e.find(
      (t2) => t2.name.toLowerCase() === s8.toLowerCase()
    );
    return (s8, t2) => (openBlock(), createBlock(T, {
      class: "overflow-auto",
      defaultOpen: false,
      itemCount: s8.headers.length
    }, {
      title: withCtx(() => t2[0] || (t2[0] = [
        createTextVNode("Request Headers")
      ])),
      default: withCtx(() => [
        s8.headers.length ? (openBlock(), createElementBlock("div", H, [
          createVNode(_, {
            ...
            default: withCtx(() => [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(s8.headers, (o) => (openBlock(), createBlock(d, {
                key: o.name,
                ...
                default: withCtx(() => [
                  createVNode(x4, { class: "bg-b-1 sticky left-0 z-1 max-w-48 group-first/row:border-t-0" }, {
                    default: withCtx(() => {
                      var u3;
                      return [
                        typeof ((u3 = m5(o.name)) == null ? void 0 : u3.url) == "string" ? (openBlock(), createBlock(p3, {
                          key: 0,
...
var h2 = defineComponent({
  ...
  setup(s8) {
    const n2 = s8, r3 = computed(() => {
      var e3;
      const o = ((e3 = t(n2.type ?? "")) == null ? void 0 : e3.extension) ?? ".unknown";
      return n2.filename ? n2.filename : `response${o}`;
    });
    return (o, e3) => (openBlock(), createElementBlock("a", {
      class: "text-c-3 text-xxs hover:bg-b-3 flex items-center gap-1 rounded px-1.5 py-0.5 no-underline",
      download: `${r3.value}`,
      href: o.href,
      onClick: e3[0] || (e3[0] = withModifiers(() => {
      }, ["stop"]))
    }, [
      createVNode(unref(m), {
        icon: "Download",
      ...
      e3[1] || (e3[1] = createBaseVNode("span", null, [
...
var $3 = defineComponent({
  ...
  setup(u3) {
    ...
    return watch(
      () => u3.src,
      () => r3.value = false
    ), (e3, o) => !r3.value && e3.src ? (openBlock(), createElementBlock("div", {
      key: 0,
      class: normalizeClass(["flex justify-center overflow-auto rounded-b", { "bg-preview p-2": e3.alpha }])
    }, [
      e3.mode === "image" ? (openBlock(), createElementBlock("img", {
        key: 0,
        class: normalizeClass(["h-full max-w-full", { rounded: e3.alpha }]),
        src: e3.src,
        onError: o[0] || (o[0] = (t2) => r3.value = true)
      }, null, 42, c3)) : e3.mode === "video" ? (openBlock(), createElementBlock("video", {
        key: 1,
        autoplay: "",
        controls: "",
        width: "100%",
      ...
      ], 32)) : e3.mode === "audio" ? (openBlock(), createElementBlock("audio", {
        key: 2,
        class: "my-12",
        controls: "",
...
var v = { class: "scalar-code-block group/code-block body-raw grid min-h-0 overflow-hidden p-px outline-none has-[:focus-visible]:outline" };
var C3 = {
...
var M = defineComponent({
  ...
  setup(a3) {
    const o = a3, t2 = ref(null), d6 = useId(), { codeMirror: i5 } = useCodeMirror({
      codeMirrorRef: t2,
      readOnly: true,
      lineNumbers: true,
      content: toRef(() => prettyPrintJson(o.content)),
      language: toRef(() => o.language),
      forceFoldGutter: true
    }), r3 = () => {
      var e3;
      return ((e3 = i5.value) == null ? void 0 : e3.state.doc.toString()) || "";
    };
    return (e3, h3) => (openBlock(), createElementBlock("div", v, [
      r3() ? (openBlock(), createBlock(unref(c), {
        key: 0,
        content: r3(),
        controls: unref(d6),
        class: "z-context top-2 mr-2"
      }, null, 8, ["content", "controls"])) : createCommentVNode("", true),
...
var s5 = s(M, [["__scopeId", "data-v-85d2902e"]]);

// node_modules/@scalar/api-client/dist/views/Request/ResponseSection/ResponseBodyToggle.vue.js
var a2 = { class: "text-c-3 text-xxs -my-1 flex justify-center gap-0.5 rounded p-0.5" };
var i4 = defineComponent({
  ...
  setup(p6) {
    return (e3, t2) => (openBlock(), createElementBlock("div", a2, [
      createBaseVNode("button", {
        class: normalizeClass(["hover:bg-b-3 rounded px-1", { "bg-b-3 text-c-1 cursor-default": e3.modelValue }]),
        type: "button",
        onClick: t2[0] || (t2[0] = withModifiers((s8) => e3.$emit("update:modelValue", true), ["stop"]))
      }, " Preview ", 2),
      createBaseVNode("button", {
        class: normalizeClass(["hover:bg-b-3 rounded px-1", { "bg-b-3 text-c-1 cursor-default": !e3.modelValue }]),
        type: "button",
        onClick: t2[1] || (t2[1] = withModifiers((s8) => e3.$emit("update:modelValue", false), ["stop"]))
      }, " Raw ", 2)
    ]));
  }
});
...
var Y = defineComponent({
  ...
  setup(k2) {
    const c4 = k2, s8 = ref(true), p6 = computed(
      () => {
        var t2;
        return !!((t2 = e3.value) != null && t2.raw && e3.value.preview);
      }
    ), B6 = computed(() => s8.value || !p6.value), R2 = computed(() => !s8.value || !p6.value), { mimeType: i5, attachmentFilename: V2, dataUrl: l5 } = b2({
      data: toRef(c4, "data"),
      headers: toRef(c4, "headers")
    }), e3 = computed(() => t(i5.value.essence));
    return (t2, u3) => (openBlock(), createBlock(T, {
        ...
        return [
          t2.data ? (openBlock(), createElementBlock("div", q, [
            createBaseVNode("div", z2, [
              createBaseVNode("span", A, toDisplayString(unref(i5).essence), 1),
              p6.value ? (openBlock(), createBlock(i4, {
                key: 0,
                modelValue: s8.value,
                "onUpdate:modelValue": u3[0] || (u3[0] = (b5) => s8.value = b5)
              }, null, 8, ["modelValue"])) : createCommentVNode("", true)
            ]),
            (f7 = e3.value) != null && f7.raw && R2.value ? (openBlock(), createBlock(s5, {
              key: unref(l5),
              content: t2.data,
              language: e3.value.language
            }, null, 8, ["content", "language"])) : createCommentVNode("", true),
            (v2 = e3.value) != null && v2.preview && B6.value ? (openBlock(), createBlock(s4, {
              key: unref(l5),
              alpha: e3.value.alpha,
              mode: e3.value.preview,
              src: unref(l5),
              type: unref(i5).essence
            }, null, 8, ["alpha", "mode", "src", "type"])) : createCommentVNode("", true),
            !((y = e3.value) != null && y.raw) && !((h3 = e3.value) != null && h3.preview) ? (openBlock(), createBlock(p4, { key: 2 }, {
...
var e2 = s(Y, [["__scopeId", "data-v-17966bf4"]]);

// node_modules/@scalar/api-client/dist/views/Request/ResponseSection/ResponseBodyStreaming.vue.js
var T2 = { class: "flex w-full items-center justify-between" };
var E3 = {
  key: 0,
...
var z3 = defineComponent({
  ...
  setup(f7) {
    const e3 = x(), o = ref(""), a3 = ref(null), m5 = new TextDecoder(), r3 = ref(null), v2 = () => {
    ...
    async function x7() {
      try {
        for (; e3.isLoading; ) {
          const { done: n2, value: t2 } = await f7.reader.read();
          if (n2) {
            e3.stopLoading();
            break;
          }
          t2 && (o.value += m5.decode(t2, { stream: true }));
        }
      } catch (n2) {
        console.error("Error reading stream:", n2), e3.stopLoading(), a3.value = n2;
      } finally {
        o.value += m5.decode();
      }
    }
    return onMounted(() => {
      e3.startLoading(), x7(), a3.value = null;
    }), onBeforeUnmount(() => {
      f7.reader.cancel(), e3.stopLoading();
    }), (n2, t2) => (openBlock(), createBlock(T, { class: "max-h-content overflow-y-hidden" }, {
      title: withCtx(() => [
        createBaseVNode("div", T2, [
          t2[1] || (t2[1] = createBaseVNode("div", null, "Body", -1)),
          unref(e3).isLoading ? (openBlock(), createElementBlock("div", E3, [
            createVNode(unref(f), {
              loadingState: unref(e3),
              size: "xs"
            }, null, 8, ["loadingState"]),
      ...
      default: withCtx(() => [
        createBaseVNode("div", {
          ...
          a3.value ? (openBlock(), createElementBlock("div", N, toDisplayString(a3.value.message), 1)) : createCommentVNode("", true),
...
var R = defineComponent({
  ...
  setup(l5) {
    const o = l5, i5 = computed(() => formatJsonOrYamlString(o.content)), { mimeType: m5, attachmentFilename: d6, dataUrl: n2 } = b2({
      data: toRef(o, "data"),
      headers: toRef(o, "headers")
    });
    return (w2, t2) => (openBlock(), createBlock(T, { class: "!max-h-100% response-body-virtual overflow-x-auto" }, createSlots({
      title: withCtx(() => [
...
var B4 = defineComponent({
  ...
  setup(x7) {
    return (s8, l5) => (openBlock(), createBlock(T, { defaultOpen: false }, {
      title: withCtx(() => l5[0] || (l5[0] = [
        createTextVNode("Cookies")
      ])),
      default: withCtx(() => [
        (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          s8.cookies.length ? (openBlock(), createBlock(_, {
            key: 0,
            class: "flex-1",
            columns: ["", ""]
          }, {
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList(s8.cookies, (o) => (openBlock(), createBlock(d, {
                key: o.name
              }, {
                default: withCtx(() => [
                  createVNode(x4, {
...
var U = defineComponent({
  ...
  setup(r3) {
    const { events: a3, requestMutators: x7 } = je(), g2 = useRoute(), b5 = useRouter(), { layout: n2 } = s2(), f7 = () => {
      var l5;
      const o = (l5 = r3.operation.tags) != null && l5.length ? { tags: r3.operation.tags[0] ? [r3.operation.tags[0]] : [] } : {}, e3 = x7.add(o, r3.collection.uid);
      e3 && (b5.push({
        name: "request",
        params: {
      ...
      o != null && o.createNew && g2.name === "request" && f7();
    }, w2 = "2.5.26";
    return onMounted(() => a3.hotKeys.on(k2)), onBeforeUnmount(() => a3.hotKeys.off(k2)), (o, e3) => (openBlock(), createElementBlock("div", W, [
      createBaseVNode("div", {
        ...
        unref(n2) !== "modal" ? (openBlock(), createElementBlock("div", $4, [
          createTextVNode(" Scalar App V" + toDisplayString(unref(w2)) + " Beta ", 1),
          e3[3] || (e3[3] = createBaseVNode("div", { class: "mt-2" }, [
            createBaseVNode("a", {
      ...
      createBaseVNode("div", j, [
        unref(n2) !== "modal" ? (openBlock(), createElementBlock("button", {
          ...
          type: "button",
          onClick: e3[0] || (e3[0] = (l5) => unref(a3).commandPalette.emit())
        }, [
          e3[5] || (e3[5] = createTextVNode(" Get Started ")),
          createVNode(unref(E2), { hotkey: "k" })
        ])) : createCommentVNode("", true),
        unref(n2) === "desktop" ? (openBlock(), createElementBlock("button", {
          key: 1,
          class: "flex items-center gap-1.5",
          type: "button",
          onClick: e3[1] || (e3[1] = (l5) => f7())
        }, [
          e3[6] || (e3[6] = createTextVNode(" New Request ")),
          createVNode(unref(E2), { hotkey: "N" })
        ])) : createCommentVNode("", true),
        createBaseVNode("button", {
          class: "flex items-center gap-1.5",
          type: "button",
          onClick: e3[2] || (e3[2] = (l5) => unref(a3).executeRequest.emit())
        }, [
          e3[7] || (e3[7] = createTextVNode(" Send Request ")),
          createVNode(unref(E2), { hotkey: "↵" })
        ])
      ])
    ]));
  }
...
var s6 = s(U, [["__scopeId", "data-v-6d2bdb61"]]);
...
var T3 = defineComponent({
  ...
  setup(v2) {
    const m5 = (s8) => e.find(
      (r3) => r3.name.toLowerCase() === s8.toLowerCase()
    );
    return (s8, r3) => (openBlock(), createBlock(T, {
      class: "overflow-auto",
      defaultOpen: false,
      itemCount: s8.headers.length
    }, {
      ...
      default: withCtx(() => [
        s8.headers.length ? (openBlock(), createElementBlock("div", H2, [
          createVNode(_, {
            columns: ["minmax(auto, min-content)", "minmax(50%, 1fr)"],
            scroll: ""
          }, {
                ...
                default: withCtx(() => [
                  createVNode(x4, { class: "bg-b-1 sticky left-0 z-1 max-w-48 group-first/row:border-t-0" }, {
                    default: withCtx(() => {
                      var d6;
                      return [
                        typeof ((d6 = m5(o.name)) == null ? void 0 : d6.url) == "string" ? (openBlock(), createBlock(p3, {
                          key: 0,
                          class: "decoration-c-3",
                          href: m5(o.name).url
                        }, {
        ...
        ])) : (openBlock(), createElementBlock("div", C4, " No Headers "))
      ]),
      _: 1
    }, 8, ["itemCount"]));
  }
...
var b4 = defineComponent({
  ...
  setup(S2) {
    const { events: n2 } = je(), t2 = x(), a3 = ref();
    return n2.requestStatus.on((s8) => {
      s8 === "start" ? a3.value = setTimeout(() => t2.startLoading(), 1e3) : (clearTimeout(a3.value), a3.value = void 0, t2.stopLoading());
    }), (s8, o) => (openBlock(), createBlock(Transition, null, {
      default: withCtx(() => [
        unref(t2).isLoading ? (openBlock(), createElementBlock("div", L, [
          ...
          createVNode(unref($), {
            variant: "ghost",
            onClick: o[0] || (o[0] = (C5) => unref(n2).cancelRequest.emit())
          }, {
...
var x6 = { class: "text-c-1 flex gap-1.5" };
var z4 = { key: 0 };
var D2 = { key: 0 };
var E4 = { key: 1 };
var $5 = defineComponent({
  ...
  setup(g2) {
    const C5 = g2, { events: S2 } = je(), l5 = ref(), u3 = ref(0);
    S2.requestStatus.on((e3) => {
      e3 === "start" ? l5.value = setInterval(() => u3.value += 1e3, 1e3) : (clearInterval(l5.value), l5.value = void 0, u3.value = 0);
    });
    const i5 = (e3) => {
      var c4, m5;
      const t2 = Number.parseInt(
        ((c4 = e3.headers) == null ? void 0 : c4["Content-Length"]) || ((m5 = e3.headers) == null ? void 0 : m5["content-length"]) || "0",
        10
      );
      return t2 ? prettyBytes(t2) : void 0;
    }, s8 = computed(() => {
      const e3 = C5.response.status;
      if (e3)
        return httpStatusCodes[e3] ?? void 0;
    });
    return (e3, t2) => (openBlock(), createElementBlock("div", x6, [
      l5.value && u3.value ? (openBlock(), createElementBlock("span", z4, toDisplayString(unref(prettyMilliseconds)(u3.value)), 1)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
        createBaseVNode("span", null, [
          ...
          createTextVNode(" " + toDisplayString(unref(prettyMilliseconds)(e3.response.duration)), 1)
        ]),
        i5(e3.response) ? (openBlock(), createElementBlock("span", D2, [
          t2[1] || (t2[1] = createBaseVNode("span", { class: "sr-only" }, ", Size:", -1)),
          createTextVNode(" " + toDisplayString(i5(e3.response)), 1)
        ])) : createCommentVNode("", true),
        s8.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          t2[2] || (t2[2] = createBaseVNode("span", { class: "sr-only" }, ", Status:", -1)),
          s8.value.url ? (openBlock(), createBlock(p3, {
            key: 0,
            class: "flex items-center gap-1.5",
            href: s8.value.url
          }, {
            default: withCtx(() => [
              createTextVNode(toDisplayString(e3.response.status) + " " + toDisplayString(s8.value.name) + " ", 1),
              createBaseVNode("span", {
                class: "block h-1.5 w-1.5 rounded-full",
                style: normalizeStyle({ backgroundColor: s8.value.color })
              }, null, 4)
            ]),
            _: 1
          }, 8, ["href"])) : (openBlock(), createElementBlock("span", E4, [
            createTextVNode(toDisplayString(e3.response.status) + " " + toDisplayString(s8.value.name) + " ", 1),
            createBaseVNode("span", {
              class: "block h-1.5 w-1.5 rounded-full",
              style: normalizeStyle({ backgroundColor: s8.value.color })
...
var me = defineComponent({
  ...
  setup(r3) {
    const R2 = i2().getViewComponents("response.section"), f7 = computed(() => {
      var o;
      const e3 = (o = r3.response) == null ? void 0 : o.headers;
      return e3 ? Object.keys(e3).map((n2) => ({
        name: n2,
        value: e3[n2] ?? "",
        required: false
      })) : [];
      ...
      () => {
        var e3;
        return ((e3 = r3.response) == null ? void 0 : e3.cookieHeaderKeys.flatMap((o) => {
          var i5, p6;
          const n2 = (p6 = (i5 = r3.response) == null ? void 0 : i5.headers) == null ? void 0 : p6[o];
          return n2 ? {
            name: o,
            value: n2,
            required: false
    ...
    ), C5 = ["Cookies", "Headers", "Body"], s8 = ref("All"), h3 = computed(() => ["All", ...C5]), t2 = computed(
      () => Object.fromEntries(
        h3.value.map((e3) => [e3, useId()])
      )
    ), H3 = computed(() => {
      var i5, p6;
      if (!r3.response || !("size" in r3.response))
        return false;
      const e3 = ((i5 = r3.response.headers) == null ? void 0 : i5["content-type"]) || ((p6 = r3.response.headers) == null ? void 0 : p6["Content-Type"]);
      return !e3 || (r3.response.size ?? 0) <= g || e3.includes("text/html") ? false : [
        // Text types
        "text/",
        // JSON types
        "application/json",
      ...
      ].some((u3) => e3.includes(u3)) && (r3.response.size ?? 0) > g;
    }), V2 = computed(
      () => {
        var e3;
        return ((e3 = r3.requestResult) == null ? void 0 : e3.request.parameters.headers.filter((o) => o.enabled).map((o) => ({
          name: o.key,
          value: o.value,
          required: true
        }))) ?? [];
    ...
    return (e3, o) => (openBlock(), createBlock(b, { "aria-label": "Response" }, {
      title: withCtx(() => [
        createBaseVNode("div", J, [
          createBaseVNode("div", {
            "aria-live": "polite",
            class: normalizeClass(["flex items-center", { "animate-response-heading": e3.response }])
          }, [
            o[1] || (o[1] = createBaseVNode("span", { class: "response-heading pointer-events-none absolute" }, " Response ", -1)),
            e3.response ? (openBlock(), createBlock($5, {
              key: 0,
          ...
          createVNode(f3, {
            modelValue: s8.value,
            "onUpdate:modelValue": o[0] || (o[0] = (n2) => s8.value = n2),
            filterIds: t2.value,
            filters: h3.value
        ...
        return [
          createBaseVNode("div", {
            ...
            class: normalizeClass(["custom-scroll response-section-content relative grid h-full justify-stretch", {
              "content-start": e3.response
            }]),
            role: s8.value === "All" && e3.response ? "tabpanel" : "none"
          }, [
            e3.response ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
              s8.value === "All" || s8.value === "Cookies" ? (openBlock(), createBlock(B4, {
                key: 0,
                class: "response-section-content-cookies",
                id: t2.value.Cookies,
                cookies: q2.value,
                role: s8.value === "All" ? "none" : "tabpanel"
              }, null, 8, ["id", "cookies", "role"])) : createCommentVNode("", true),
              s8.value === "All" || s8.value === "Headers" ? (openBlock(), createBlock(D, {
                key: 1,
              ...
              s8.value === "All" || s8.value === "Headers" ? (openBlock(), createBlock(T3, {
                key: 2,
                class: "response-section-content-headers",
                id: t2.value.Headers,
                headers: f7.value,
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(R2), (u3) => (openBlock(), createBlock(unref(E), {
                ...
                default: withCtx(() => [
                  withDirectives((openBlock(), createBlock(resolveDynamicComponent(u3.component), mergeProps({ ref_for: true }, u3.props ?? {}), null, 16)), [
                    [vShow, s8.value === "All" || s8.value === u3.title]
                  ])
                ]),
                _: 2
              }, 1024))), 128)),
              s8.value === "All" || s8.value === "Body" ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
                "reader" in e3.response ? (openBlock(), createBlock(z3, {
                  key: 0,
                  class: "response-section-content-body",
                  id: t2.value.Body,
                  reader: e3.response.reader
                }, null, 8, ["id", "reader"])) : H3.value && typeof ((n2 = e3.response) == null ? void 0 : n2.data) == "string" ? (openBlock(), createBlock(R, {
                  key: 1,
                  id: t2.value.Body,
                  content: e3.response.data,
                  data: (i5 = e3.response) == null ? void 0 : i5.data,
                  headers: f7.value,
                  role: s8.value === "All" ? "none" : "tabpanel"
                  ...
                  layout: "client",
                  active: true,
                  data: (p6 = e3.response) == null ? void 0 : p6.data,
                  headers: f7.value,
                  role: s8.value === "All" ? "none" : "tabpanel",
                  title: "Body"
                }, null, 8, ["id", "data", "headers", "role"]))
              ], 64)) : createCommentVNode("", true)
            ], 64)) : (openBlock(), createBlock(s6, {
              key: 0,
              collection: e3.collection,
              operation: e3.operation,
              workspace: e3.workspace,
              numWorkspaceRequests: e3.numWorkspaceRequests
...
var s7 = s(me, [["__scopeId", "data-v-7138ed84"]]);
...
var re = defineComponent({
  ...
  emits: ["newTab"],
  setup($6) {
    const { events: R2 } = je(), { isSidebarOpen: a3 } = m2(), q2 = je(), { layout: h3 } = s2(), {
      activeCollection: r3,
      activeExample: m5,
      activeRequest: l5,
      activeWorkspace: i5,
      ...
      activeEnvironment: v2,
      activeWorkspaceRequests: x7
    } = z(), { modalState: C5, requestHistory: V2 } = q2, w2 = computed(
      () => [...V2].reverse().find((t2) => {
        var o;
        return t2.request.uid === ((o = m5.value) == null ? void 0 : o.uid);
      })
    );
    function _2(t2) {
      var o;
      R2.commandPalette.emit({
        ...
        metaData: {
          parsedCurl: C(t2),
          collectionUid: (o = r3.value) == null ? void 0 : o.uid
        }
      });
    }
    return (t2, o) => unref(r3) && unref(i5) ? (openBlock(), createElementBlock("div", {
      key: 0,
      ...
      createBaseVNode("div", O2, [
        unref(l5) ? (openBlock(), createElementBlock("div", T4, [
          createVNode(p2, {
            modelValue: unref(a3),
            "onUpdate:modelValue": o[0] || (o[0] = (n2) => isRef(a3) ? a3.value = n2 : null),
            collection: unref(r3),
            envVariables: unref(d6),
            environment: unref(v2),
            operation: unref(l5),
            server: unref(p6),
            workspace: unref(i5),
            onHideModal: o[1] || (o[1] = () => unref(C5).hide()),
            onImportCurl: _2
          }, null, 8, ["modelValue", "collection", "envVariables", "environment", "operation", "server", "workspace"]),
          createVNode(u, null, {
            default: withCtx(() => [
              unref(m5) ? (openBlock(), createBlock(x2, {
                key: 0,
                class: normalizeClass(["flex-1", [unref(a3) ? "sidebar-active-hide-layout" : ""]])
              }, {
                default: withCtx(() => {
                  var n2;
                  return [
                    createVNode(a, {
                      ...
                      environment: unref(v2),
                      example: unref(m5),
                      invalidParams: t2.invalidParams,
                      operation: unref(l5),
                      selectedSecuritySchemeUids: t2.selectedSecuritySchemeUids,
                      server: unref(p6),
                      workspace: unref(i5)
                    ...
                    createVNode(s7, {
                      ...
                      operation: unref(l5),
                      workspace: unref(i5),
                      requestResult: t2.requestResult,
                      numWorkspaceRequests: unref(x7).length,
                      response: (n2 = w2.value) == null ? void 0 : n2.response
...
var m4 = s(re, [["__scopeId", "data-v-0100effe"]]);
export {
  m4 as default
};
//# sourceMappingURL=Request.vue-C5SQSRWI.js.map
